...
import '../../domain/usecases/send_message.dart' as _i822;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i494.ChatRemoteDatasource>(
      () => dataSourceModule.provideChatRemoteDatasource(gh<_i361.Dio>()),
    );
    gh.lazySingleton<_i1072.ChatRepository>(
      () => _i838.ChatRepositoryImpl(
        remoteDatasource: gh<_i494.ChatRemoteDatasource>(),
      ),
    );
    gh.lazySingleton<_i822.SendMessage>(
