...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ServerFailure value)?  serverFailure,TResult Function( NetworkFailure value)?  networkFailure,TResult Function( CacheFailure value)?  cacheFailure,TResult Function( ValidationFailure value)?  validationFailure,TResult Function( UnauthorizedFailure value)?  unauthorizedFailure,TResult Function( NotFoundFailure value)?  notFoundFailure,TResult Function( UnknownFailure value)?  unknownFailure,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return unauthorizedFailure(_that);case NotFoundFailure() when notFoundFailure != null:
return notFoundFailure(_that);case UnknownFailure() when unknownFailure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ServerFailure value)  serverFailure,required TResult Function( NetworkFailure value)  networkFailure,required TResult Function( CacheFailure value)  cacheFailure,required TResult Function( ValidationFailure value)  validationFailure,required TResult Function( UnauthorizedFailure value)  unauthorizedFailure,required TResult Function( NotFoundFailure value)  notFoundFailure,required TResult Function( UnknownFailure value)  unknownFailure,}){
final _that = this;
switch (_that) {
case ServerFailure():
...
return unauthorizedFailure(_that);case NotFoundFailure():
return notFoundFailure(_that);case UnknownFailure():
return unknownFailure(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ServerFailure value)?  serverFailure,TResult? Function( NetworkFailure value)?  networkFailure,TResult? Function( CacheFailure value)?  cacheFailure,TResult? Function( ValidationFailure value)?  validationFailure,TResult? Function( UnauthorizedFailure value)?  unauthorizedFailure,TResult? Function( NotFoundFailure value)?  notFoundFailure,TResult? Function( UnknownFailure value)?  unknownFailure,}){
final _that = this;
switch (_that) {
case ServerFailure() when serverFailure != null:
return serverFailure(_that);case NetworkFailure() when networkFailure != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? message)?  serverFailure,TResult Function( String? message)?  networkFailure,TResult Function( String? message)?  cacheFailure,TResult Function( String? message)?  validationFailure,TResult Function( String? message)?  unauthorizedFailure,TResult Function( String? message)?  notFoundFailure,TResult Function( String? message)?  unknownFailure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ServerFailure() when serverFailure != null:
...
return unauthorizedFailure(_that.message);case NotFoundFailure() when notFoundFailure != null:
return notFoundFailure(_that.message);case UnknownFailure() when unknownFailure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? message)  serverFailure,required TResult Function( String? message)  networkFailure,required TResult Function( String? message)  cacheFailure,required TResult Function( String? message)  validationFailure,required TResult Function( String? message)  unauthorizedFailure,required TResult Function( String? message)  notFoundFailure,required TResult Function( String? message)  unknownFailure,}) {final _that = this;
switch (_that) {
case ServerFailure():
...
return unauthorizedFailure(_that.message);case NotFoundFailure():
return notFoundFailure(_that.message);case UnknownFailure():
return unknownFailure(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? message)?  serverFailure,TResult? Function( String? message)?  networkFailure,TResult? Function( String? message)?  cacheFailure,TResult? Function( String? message)?  validationFailure,TResult? Function( String? message)?  unauthorizedFailure,TResult? Function( String? message)?  notFoundFailure,TResult? Function( String? message)?  unknownFailure,}) {final _that = this;
switch (_that) {
case ServerFailure() when serverFailure != null:
return serverFailure(_that.message);case NetworkFailure() when networkFailure != null:
return networkFailure(_that.message);case CacheFailure() when cacheFailure != null:
